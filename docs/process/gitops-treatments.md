...
|---|---|---|---|
| 1 | #4 agent-driver routing architecture (per investigation 0002 D1) | 4a router-in-driver · 4b pack-declared routing policy · 4c verified escalation ladder | treating |
